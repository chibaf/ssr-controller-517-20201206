        ...
        while self.running:
            try:
                ...
                if buff_waiting > 0:
                    ...
                    # time_stamp also transfered {201130}
                    temp12345_list=[temperatures[1],temperatures[2],temperatures[3],temperatures[4],temperatures[5]]  #{201116	}
                    #print(f"temp2345_list = {temp2345_list}")
                    self.q_tc_temp.put(temp12345_list)
                    #self.q_tc_temp.put(temperatures[2])
